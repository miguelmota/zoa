...
describe('Zoa', function() {
  ...
  it('should inject dependencies', function() {
    ...
    zoa.injector.register('greeting', greeting, false);
  ...
  it('should set and get modules', function() {
    var test = {};
    var app = zoa.app();
    ...
    robots.doWork('dishes');

    console.log(test[1]);
    assert.equal(test[1], 'Working dishes.');
    var deps = Object.keys(app.injector.dependencies);
    assert.deepEqual(deps, ['work']);

    function beep() {
      return 'boop';
    }

    app.injector.register('beep', beep, false);

    app.module('computer', function(beep) {
      return {
        doBeep: function() {
          return beep();
        }
    ...
    var computer = app.module('computer');

    assert.equal(computer.doBeep(), 'boop');
